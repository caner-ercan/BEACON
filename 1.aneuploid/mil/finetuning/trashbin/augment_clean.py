...
deneme_ds = CustomDataset(list_images=tif_files, transform=custom_transform)
BATCH_SZ = 64
...
LABELS = tf.cast(tf.equal(tf.expand_dims(LABELS, axis=0), tf.expand_dims(LABELS, axis=1)), tf.float32)
