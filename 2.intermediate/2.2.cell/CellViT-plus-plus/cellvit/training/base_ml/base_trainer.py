                ...
                if self.early_stopping is not None:
                    ...
                    if best_model:
                        ...
                        if test_dataloader is not None:
                            ...
                            # add best suffix to val metrics, conconate to test and submit. 
                            val_scalar_metrics_best = {f"{key}-best": value for key, value in val_scalar_metrics.items()}
                            train_scalar_metrics_best = {f"{key}-best": value for key, value in train_scalar_metrics.items()}

                            test_scalar_metrics.update(val_scalar_metrics_best)
                            test_scalar_metrics.update(train_scalar_metrics_best)
