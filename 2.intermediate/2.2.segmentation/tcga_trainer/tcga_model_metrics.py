...
source_path = os.path.join(BE_MASTER, "2.intermediate/2.3.segmentation/finetuner/tcga_trainer/4Caner_patch896_BCSS/")
...
model_parent_folder = os.path.join(BE_MASTER, "2.intermediate/2.3.segmentation/training/finetuning/tcga_pretrain")
