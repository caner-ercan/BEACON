...
cache_dir = os.path.join(BE_MASTER, "2.intermediate/2.3.segmentation/finetuner/model_cache")
...
model_path = os.path.join(BE_MASTER, "2.intermediate/2.3.segmentation/training/finetuning/from_tcga_ds1/mit-b0/0.0001/finetuned_model.h5")
...
tiles_folder = os.path.join(BE_MASTER, "2.intermediate/2.4.inference/tiles_segmentation/")
wsi_samples = [filename for filename in os.listdir(tiles_folder) if os.path.isdir(os.path.join(tiles_folder,filename))]
output_folder = os.path.join(BE_MASTER, "2.intermediate/2.4.inference/wsi_segment_masks/")
