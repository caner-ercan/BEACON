...
train_data_generator = CustomImageDataGenerator(x_df=x_train_dir, y_df=y_train_dir, batch_size=batch_size, img_size=img_size, augment=False, shuffle=False)
...
# Save model
model.load_weights(os.path.join(exp_folder, "finetuned_model.h5"))
